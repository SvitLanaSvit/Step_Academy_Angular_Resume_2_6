...
import { ResumeInfo } from './skill.service';
...
export class AppComponent implements OnInit {
  ...
  constructor(private info: ResumeInfo){}
  ngOnInit(): void {
    this.skillsFirst = this.info.getFirstSkills();
    this.skillsSecond = this.info.getSecondSkills();
    this.experiences = this.info.getExperience();
  }
